...
const TokenFooter = () => {
  ...
  return (
    <footer id="contact" className="relative py-16 border-t border-border/50">
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-yellow-500/10 blur-[150px] rounded-full" />
        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-display text-2xl font-bold bg-gradient-to-r from-yellow-500 to-amber-600 bg-clip-text text-transparent">
                TOKEN SMP
              </span>
            </div>
            <p className="text-muted-foreground max-w-md">
              Your ultimate destination for premium Minecraft items on Token SMP. Join the adventure today!
            </p>
          </motion.div>
